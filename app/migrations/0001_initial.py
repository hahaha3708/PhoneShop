# Generated by Django 4.2.24 on 2025-09-17 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_new', models.DecimalField(blank=True, decimal_places=0, max_digits=12, null=True)),
        ...
        migrations.AddField(
            model_name='capacity',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='capacities', to='app.product'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
